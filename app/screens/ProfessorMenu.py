...
from app.screens.professor_screens.Inicio import Inicio
from app.screens.professor_screens.ShowAlunos import ShowAlunos
...
class ProfessorMenu(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.lbuttons_dic['botao2'] = tk.Button(text="Alunos", font="Arial, %s" % str(parent.appw//80), highlightthickness=0, bd=0, command=self.show_alunos)
