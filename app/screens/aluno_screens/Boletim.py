...
class Boletim(tk.Frame):
    ...
    def __init__(self, parent, screen, notas):
        ...
        self.dicd = {}
        self.dicd['main'] = tk.Label(self.parent, text="DISCIPLINA", anchor=tk.W)
        self.dicn1 = {}
        ...
        for disciplina in notas:
            self.dicd[disciplina] = tk.Label(self.parent, text=disciplina, anchor=tk.W)
        cont = 0
        ...
        for disciplina in notas:
            self.dicn1[disciplina] = tk.Label(self.parent, text=notas[disciplina][1])
        cont = 0
        ...
        for disciplina in notas:
            self.dicn2[disciplina] = tk.Label(self.parent, text=notas[disciplina][2])
        cont = 0
        ...
        for disciplina in notas:
            self.dicn3[disciplina] = tk.Label(self.parent, text=notas[disciplina][3])
        cont = 0
        ...
        for disciplina in notas:
            self.dicn4[disciplina] = tk.Label(self.parent, text=notas[disciplina][4])
        cont = 0
        for label in self.dicd:
